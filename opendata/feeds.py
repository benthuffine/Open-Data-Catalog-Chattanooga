...
class ResourcesFeed(BaseResourceFeed):
    title = "OpenChattanooga: Resources - All"
    link = "/feeds/resources/"
    description = "List of resources on OpenChattanooga listed in the order they were added"
...
class UpdatesFeed(BaseResourceFeed):
    title = "OpenChattanooga: Resources - Last Updated"
    link = "/feeds/updates/"
    description = "List of resources on OpenChattanooga listed in the order they were last updated"
    description_template = "feeds/resource.html"
    feed_type = Rss2
...
class IdeasFeed(Feed):
    title = "OpenChattanooga: Ideas"
    link = "/feeds/ideas/"
    description = "List of ideas on OpenChattanooga listed in the order they were added"
...
class TagFeed(BaseResourceFeed):
    ...
    def title(self, obj):
        return "OpenChattanooga: Resources in %s" % obj.tag_name
    def link(self, obj):
